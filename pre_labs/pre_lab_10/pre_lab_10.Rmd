...
**Answer** Character, multipolygon, integer and double columns
...
**Answer** It contains information on Maryland zip codes: where they are in the state, the longer version of the zip code, the shape length and area, and the geometry to go along with it.
...
**Answer** The output is a map of Maryland, with each territory broken down and a latitude and longitude coordinated in the background.  
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output gives us data from 2021, showing the state and the counties in that state.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This data gives us information on counties from only Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code shows coordinates and just the county outlines in the state.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This shows the states coordinates along with counties and thier zip code areas. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** This data frame shows us the foreclosures by zipcode in the US from March 2023.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** This data frame shows foreclosures by zip code along with their geographic location and their represented areas. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This map shows MD zip codes now color coded with the number of foreclosures in each area. 
...
library(janitor)
library(tidycensus)
census_api_key("2257b2677e5a747de92eaefb9471c94a713e78b1")
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The notices data frame shows the type which is all foreclosures and the date oof the foreclosure and the number of notices they recieved. The population data frame shows the zip code, name, variable estimate and moe. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The data shows the 5-year ACS featuring the geometry from the Census website. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Shows the date, the type of incident, the county it happened in and the notices for each foreclosure.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code renames the estimate to the population, and changes it to just the county, population and geometry.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The county notices are joined by county name.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The code shows the notices divided by the population and multiplied by 1000.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code shows shows the foreclosures and shows the area in MD map. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This map shows the number of foreclosures and now is color coded with different colors that allow the viewer to see the foreclosures better.
...
**Answer** This map shows the log representing the decimals now.
