...
**Answer** The data frame only shows the dates from January to April and shows the most recent data first. 
...
**Answer** The dates are now in date mode, easier to be searched away from this code. You might want to add links to the table so the news can be easily found. 
...
**Answer** The data suggests that there are 7 <ul> tags. 
...
**Answer** The output is the sections you can click through on the Office of the Maryland State Prosecutor. It grabs the text inside the <li> tags.  
```{r}
...
**Answer** This puts all the listed items into a dataframe.
