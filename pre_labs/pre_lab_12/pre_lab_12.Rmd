...
**Answer** This gives us all the press releases that we scraped last week as well as the text of each press release. 
...
**Answer** It removes the one word that is the same as another word, removes the one cat and the one dog (lowercase).
...
**Answer** This code gives us a list of 2, with 647091 columns. 
...
**Answer** It shows us the unique word and how often they are used in the press releases.
...
**Answer** This code joins 2 dataframes with columns that are not in the other, it only shows words in unique words that is not in stop words. 
...
**Answer** We get top terms used in each year, and in 2021 we start getting COVID. 2023 data shows more diverse words like women, rights and fire. 
...
**Task** Run the following code and describe the results.
**Answer** This code generate 2 words phrases called bigram, so these words are most commonly used together. 
...
**Task** Run the following code and describe the results.
**Answer** This shows just 2022, it is now rearanged and has different issues in thte releases. 
...
**Task** Run the following code and describe the results.
**Answer** This dataframe shows the data from 2023.
...
**Answer** This code takes words and tells you if the word has positive or negative connotation. 
